...
class VerticaRepository:
    TABLE_STAGE_CURRENCIES = 'Brok01__STAGING.currencies'
    TABLE_STAGE_CURRENCIES_REJECTED = 'Brok01__STAGING.currencies_rej'
    TABLE_STAGE_TRANSACTIONS = 'Brok01__STAGING.transactions'
    TABLE_STAGE_TRANSACTIONS_REJECTED = 'Brok01__STAGING.transactions_rej'
    TABLE_CDM_GLOBAL_METRICS = 'Brok01.global_metrics'
